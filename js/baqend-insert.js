function insertBaqendNews() {
  return DB.ready().then(function() {
    ...
    var p1 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/obam-xi-apec-2-220x124.jpg"
    });
    ...
    var p2 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/israel-anschlag-220x124.jpg"
    });
    ...
    var p3 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/zentralfrika-frankreich-truppen-220x124.jpg"
    });
    ...
    var p4 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/russland-kampfjet-220x124.jpg"
    });
    ...
    var p5 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/rentner-220x124.jpg"
    });
    ...
    var p6 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/europaeischer-gerichtshof-hartz-220x124.jpg"
    });
    ...
    var p7 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/sarkozy-jouyet-220x124.jpg"
    });
    ...
    var p8 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/anschlag-tel-aviv-220x124.jpg"
    });
    ...
    var p9 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/stasiakten-220x124.jpg"
    });
    ...
    var p10 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/bernd-fabritius-220x124.jpg"
    });
    ...
    var w1 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/geldanlage-honorarberatung-220x124.jpg"
    });
    ...
    var w2 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/china-chen-guangbiao-220x124.jpg"
    });
    ...
    var w3 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/konjunktur-china-220x124.jpg"
    });
    ...
    var w4 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/russland-zentralbank-rubel-220x124.jpg"
    });
    ...
    var w5 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/thomas-middelhoff-220x124.jpg"
    });
    ...
    var w6 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/ttip-protest-220x124.jpg"
    });
    ...
    var w7 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/globalisierung-ungleichheit-220x124.jpg"
    });
    ...
    var w8 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/lebensversicherung-220x124.jpg"
    });
    ...
    var w9 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/gdl-bahn-streik-claus-weselsky-220x124.jpg"
    });
    ...
    var w10 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/sicherheitsfirma-220x124.jpg"
    });
    ...
    var k1 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/nikolaus-harnoncourt-220x124.jpg"
    });
    ...
    var k2 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/hans-magnus-enzensberger-220x124.jpg"
    });
    ...
    var k3 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/ddr-artefakte-alltag-fs-teaser-2-220x124.jpg"
    });
    ...
    var k4 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/azealia-banks-220x124.jpg"
    });
    ...
    var k5 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/dina-foxx-zdf-220x124.jpg"
    });
    ...
    var k6 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/feridun-zaimoglu-freitext-teaser-220x124.jpg"
    });
    ...
    var k7 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/open-mike-2014-2-220x124.jpg"
    });
    ...
    var k8 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/castorf-kaputt-volksbuehne-220x124.jpg"
    });
    ...
    var k9 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/demonstranten-chile-220x124.jpg"
    });
    ...
    var k10 = DB.News.fromJSON({
      ...
      "img" : "/file/www/img/voguing-unicorn-ball-220x124.jpg"
    });
